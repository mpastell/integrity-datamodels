...
#   filename:  integrity.yaml
#   timestamp: 2023-04-06T12:38:13+00:00
...
class Herd(BaseModel):
    herdid: Optional[Any] = Field(None, description='ID of the herd')
    id: Any = Field(..., description='nglsi-id id')
    name: Optional[Any] = Field(None, description='Name of the herd')
    type: Any = Field(..., description='nglsi-id type, has to be Herd')


class Animal(BaseModel):
    animalid: Optional[float] = Field(
        None,
        description='On-farm ID of the animal, is not globally and always even locally unique.',
    )
    birthdate: Optional[Any] = Field(None, description='Animal birthdate')
    breed: Optional[str] = Field(None, description='Animal breed as 2 letter code')
    calvingdate: Optional[Any] = Field(None, description='Last calving date')
    farm: Optional[str] = Field(None, description='Reference to farm.')
    gender: Optional[Any] = Field(
        None, description='Animal gender. `M` for male or `F` for female'
    )
    herd: Optional[str] = Field(None, description='Reference to herd.')
    id: Any = Field(..., description='nglsi-id id')
    legalid: Optional[str] = Field(
        None, description='Official animal ID e.g. EU animal ID, has to be unique.'
    )
    species: Optional[str] = Field(None, description='Animal species')
    type: Any = Field(..., description='nglsi-id type, has to be Animal')


class AnimalDaily(BaseModel):
    MEintake: Optional[float] = Field(None, description='Metabolizable energy intake')
    MErequirement: Optional[float] = Field(
        None, description='Metabolizable energy requirement'
    )
    animal: Any = Field(..., description='Reference to animal')
    bodyweight: Optional[Any] = Field(None, description="Animal's live weight")
    category: Any = Field(..., description='Enum: `observed`, `predicted`')
    dateObserved: str = Field(..., description='Date')
    feedintake: Optional[Any] = Field(None, description='feed intake')
    feeds: Optional[Any] = Field(None, description='Reference to consumed feeds')
    id: Any = Field(..., description='nglsi-id id')
    methaneyield: Optional[Any] = Field(None, description='Methane yield/day.')
    milkyield: Optional[Any] = Field(None, description='Milk yield kg/day.')
    type: Any = Field(..., description='nglsi-id type, has to be AnimalDaily')


class Feed(BaseModel):
    components: Optional[List[str]] = Field(None, description='Diet components')
    id: Any = Field(..., description='nglsi-id id')
    name: Optional[Any] = Field(None, description='Name of the feed')
    relative_composition: Optional[List[float]] = Field(
        None, description='Diet relative composition'
    )
    type: Any = Field(..., description='nglsi-id type, has to be Feed')
...
class ContactPoint(BaseModel):
    ...
    email: Optional[EmailStr] = Field(
        None, description='Property. Email address of owner.'
    )
    faxNumber: Optional[str] = Field(
        None, description="Property. Model:'http://schema.org/Text'. The fax number."
    )
...
class LandLocationItem(BaseModel):
...
class LandLocationItem1(BaseModel):
    bbox: Optional[List[float]] = Field(None, min_items=4)
...
class LandLocationItem2(BaseModel):
    bbox: Optional[List[float]] = Field(None, min_items=4)
...
class LandLocationItem3(BaseModel):
    bbox: Optional[List[float]] = Field(None, min_items=4)
...
class LandLocationItem4(BaseModel):
    bbox: Optional[List[float]] = Field(None, min_items=4)
    coordinates: List[List[Coordinate]]
    type: Type4
...
class LandLocationItem5(BaseModel):
    bbox: Optional[List[float]] = Field(None, min_items=4)
...
class RelatedSourceItem(BaseModel):
    ...
    ] = Field(None, description='Property. Unique identifier of the entity')
    applicationEntityId: Optional[str] = None
...
class AgriFarm(BaseModel):
    ...
    ] = Field(None, description='List of agri parcels belonging to the farm')
    hasBuilding: Optional[
        List[
            Union[
                constr(
                    regex=r'^[\w\-\.\{\}\$\+\*\[\]`|~^@!,:\\]+$',
    ...
    ] = Field(None, description='List of buildings belonging to the farm')
    id: Union[
        constr(
            regex=r'^[\w\-\.\{\}\$\+\*\[\]`|~^@!,:\\]+$', min_length=1, max_length=256
        ),
        AnyUrl,
    ] = Field(..., description='Unique identifier of the entity')
    landLocation: Optional[
        Union[
            LandLocationItem,
            LandLocationItem1,
            LandLocationItem2,
    ...
    ] = Field(None, description='Owner (Person or Organization) of the farm')
    owner: Optional[
        List[
            Union[
                constr(
    ...
    type: Type12 = Field(..., description='NGSI Entity Type. It has to be AgriFarm')
...
class Planting(BaseModel):
    ...
    genotype: Optional[Any] = Field(
        None, description='Reference to genotype http://purl.org/icasa/core#Genotype'
    )
