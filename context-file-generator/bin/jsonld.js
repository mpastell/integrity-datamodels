function addCommonContextURLs(context) {
  ...
  context.smd = 'https://smart-data-models.github.io/data-models#';
...
function replaceCommonContextURLs(text) {
  return text
    .replace(/https:\/\/smart-data-models\.github\.io\/data-models#/g, 'smd:')
...
function getContext(api, context, expand) {
  ...
  Object.keys(api.components.schemas).forEach(obj => {
    ...
    const ngsi = schema['x-ngsi'] || {
      'uri-prefix': 'https://smart-data-models.github.io/data-models#'
    };
  ...
  Object.keys(api.components.schemas).forEach(obj => {
    ...
    const ngsi = schema['x-ngsi'] || {};
    ngsi['uri-prefix'] =
      ngsi['uri-prefix'] || 'https://smart-data-models.github.io/data-models#';
